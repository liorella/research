...
from qecsim.Shor_rep_code_generator import ShorRepCodeGenerator
...
for distance in distance_vec:
    ...
    repc = ShorRepCodeGenerator(num_stabilizer=num_stabilizer,
    ...
    for num_rounds in rounds_vec:
        ...
        for n in tqdm(range(num_iterations)):
            ...
            for i in range(num_rounds - 1):
                ...
                # apply automatic reset
                to_reset = []
                for q1, q2, cb1, cb2 in zip(repc.qubit_names[1::3], repc.qubit_names[2::3], repc.cbit_names[1::3], repc.cbit_names[2::3]):
